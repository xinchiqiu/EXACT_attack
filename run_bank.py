...
if __name__ == '__main__':
    ...
    fl = bool(args.fl)
    print('loading banking marketing dataset')
    ...
    client_model = DeepFM_client_early(client_feature_columns, client_feature_columns, 58, task='binary', l2_reg_embedding=1e-4, device = device)
